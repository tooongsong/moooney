...
export const metadata: Metadata = {
  title: 'moooney',
  description: 'A fast, minimal personal expense tracker',
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="apple-touch-startup-image" href="/splash/apple-splash-1080-1920.png" media="(device-width: 414px) and (device-height: 736px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)" />
